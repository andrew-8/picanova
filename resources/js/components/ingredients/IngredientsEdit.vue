    ...
    <div class="">
        ...
        <div class="card">
            <div class="card-header">
                Edit Ingredient for pizza "{{data.pizza.name}}"
            </div>
            <div class="card-body">
                <form v-on:submit="saveIngredient()">
                    <div class="row">
                        <div class="col-12 form-group">
                            ...
                            <input type="text" v-model="data.ingredient.name" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 form-group">
                            <label class="control-label">Price</label>
                            <input type="text" v-model="data.ingredient.price" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 form-group">
                            <label class="control-label">For Pizza</label>
                            <input type="text" v-model="data.pizza.name" disabled class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 form-group">
    ...
    export default {
        ...
        methods: {
            saveIngredient() {
                ...
                var app = this;
                app.ingredient.pizza_id = app.data.pizza.id;
                axios.put('/admin/ingredients/' + app.data.ingredient.id, app.data.ingredient)
                    .then(function (resp) {
                        app.error = false;
                        app.validate = true;
                        app.info = null;
                        if (!resp.data.result){
                            ...
                            if (resp.data.result.id)  {
                                app.success = true;
                                app.info = 'Ingredient "' + resp.data.result.name + '" successfully updated';
                                setTimeout(function(){
